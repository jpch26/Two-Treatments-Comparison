...
That's it! I think there is no better way to learn than learn by doing. Why don't you try to reproduce all this analysis by yourself? Try to use your own data! You can even clone the repository for this analysis and reproduce it step by step from scratch, just click the next link: [Simple Mean Analysis Repository](https://github.com/jpch26/simple_mean_analysis.git)  
