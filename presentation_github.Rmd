...
treatments data. This is performed through a t-Test, summarizing and graphing the data. Note that I didn't explain how I simulated the experimental data, but you can see the code on data_simulation.R  
