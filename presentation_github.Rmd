...
If you save your tables as CSV files, when you edit them to look better, be sure to save it as XLS files or a related one, this way you won't lose your editions. My final sumamry table looks like this:  
...
Comparing the bar and the point plots, maybe there doesn't seem to be too much difference, but in some cases bar plots will tend to hide the real distribution of your data. Click the next link to find more information: [#BarBarPlots!](https://thenode.biologists.com/barbarplots/photo/)  
